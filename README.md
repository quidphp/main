...
## Documentation
**QuidPHP/Main** documentation is being written. Once ready, it will be available at [QuidPhp/Docs](https://quidphp.github.io/docs).
...
**QuidPHP/Main** PHP testsuite can be run by creating a new [quidphp/assert](https://github.com/quidphp/assert) project..